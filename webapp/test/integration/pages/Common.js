sap.ui.define([
	...
	return Opa5.extend("webapp.DemoBirla.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["webapp/DemoBirla/localService/mockserver"], function (mockserver) {
